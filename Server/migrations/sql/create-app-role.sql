...
CREATE ROLE vaultkeep_app WITH LOGIN PASSWORD 'change-me';

-- Connect and read the schema, nothing more at the database level.
GRANT CONNECT ON DATABASE password_manager TO vaultkeep_app;
GRANT USAGE ON SCHEMA public TO vaultkeep_app;
