...
const PX = {
  ...
  // Drawn on the same 8x8 grid as the rest rather than using a "×"
  // character, which would render in Geist and sit visibly outside
  // the pixel family it stands next to.
  x:        ['........', '.1....1.', '..1..1..', '...11...', '...11...', '..1..1..', '.1....1.', '........']
};
